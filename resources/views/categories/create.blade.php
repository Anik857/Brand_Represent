...
<div class="container-fluid">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    <div>
      ...
      <p class="text-muted">Add a new product category to organize your inventory</p>
    </div>
          ...
          <div class="card-body">
            <div class="mb-3">
              ...
              @error('meta_title')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
              <div class="form-text">Leave empty to use category name</div>
            </div>
            <div class="mb-3">
              ...
              @error('meta_description')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
              <div class="form-text">Leave empty to use category description</div>
            </div>
          </div>
        </div>
      </div>
...
<script>
  ...
  document.getElementById('description').addEventListener('input', function() {
    ...
    if (!metaDescriptionField.value && description.length > 0) {
      // Limit to 500 characters for meta description
      metaDescriptionField.value = description.substring(0, 500);
    }
  });
</script>
@endsection
