...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Edit Update</h1>
            <p class="text-muted">Update your website update details</p>
        </div>
        <div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.new-updates.update', $newUpdate) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="title" 
                                   name="title" 
                                   value="{{ old('title', $newUpdate->title) }}" 
                                   required>
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('excerpt') is-invalid @enderror" 
                                      ...
                                      name="excerpt" 
                                      rows="3" 
                                      required>{{ old('excerpt', $newUpdate->excerpt) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror" 
                                      ...
                                      name="content" 
                                      rows="10" 
                                      required>{{ old('content', $newUpdate->content) }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="author" 
                                           name="author" 
                                           value="{{ old('author', $newUpdate->author) }}" 
                                           required>
                                    @error('author')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" 
                                               ...
                                               name="is_published" 
                                               value="1" 
                                               {{ old('is_published', $newUpdate->is_published) ? 'checked' : '' }}>
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('blogs.show', $newUpdate) }}" 
                           ...
                           target="_blank">
                            <i class="fas fa-external-link-alt me-2"></i>View Update
                        </a>
                        <button type="button" 
